...
Recognized placeholders (e.g., REPLACE_WITH_PASSWORD, <password>, ${VAR}) are
...
def main() -> int:
    ...
    sys.stderr.write(
        ...
        "use a recognized placeholder — REPLACE_WITH_PASSWORD, <password>, "
        "${REDIS_PASS}, etc. — or temporarily disable the redis-companion plugin.\n"
    )
